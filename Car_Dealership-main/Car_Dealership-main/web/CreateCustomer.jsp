        ...
        <div class="container">
            ...
            <form action="MainServlet" method="post">
                <div class="form-group">
                    <input type="text" id="custName" name="custName" placeholder="Enter name" required>
                </div>
                <div class="form-group">
                    <input type="text" id="phone" name="phone" placeholder="Enter phone" required>
                </div>
                <div class="form-group">
                    <label class="label-sex">Sex:</label>
                ...
                <div class="form-group-buttons">
                    ...
                    <a href="MainServlet?action=LOAD_CUSTOMER" class="btn btn-back">Back to List</a>
                </div>
            </form>
